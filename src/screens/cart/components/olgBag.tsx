...
const CartScreen: React.FC = () => {
  ...
  //   try {
  //     const response = await fetch('https://go-devil-backend.iqsetters.com/create-order/', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'application/json',
  //       },
  ...
  // const openRazorpayCheckout = (order_id, amount, key) => {
  //   const options = {
  //     key: key,
  ...
  // const handlePaymentSuccess = async (payment_id, order_id) => {
  //   try {
  //     const response = await fetch(
  //       'https://go-devil-backend.iqsetters.com/capture-payment/',
  //       {
  //         method: 'POST',
  //         headers: {
  //           'Content-Type': 'application/json',
      ...
      <FlatList
        ...
        ListFooterComponent={() => (
          <View style={{marginBottom: 10}}>
            ...
            <View style={{flexDirection: 'row', marginTop: 10}}>
              <View style={{width: '70%'}}>
                <Text
                  style={[
                    styles.productText,
                    {fontFamily: fonts.medium, fontSize: 16, color: colors.red},
                  ]}>
                  Discount
                </Text>
              </View>
            ...
            <Divider style={{backgroundColor: colors.white, marginTop: -75}} />
          </View>
        )}
      />
